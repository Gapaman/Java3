...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Коробка 1 = Коробка 3: "+or.compare(ap));
        System.out.println("Коробка 2 = Коробка 4: "+or1.compare(ap1));
        System.out.println("'f' - pourTo(): ");
        or.pourTo(or1);
        ap.pourTo(ap1);
        System.out.println( );
        System.out.println("Коробка1: "+or.getWeight());
        System.out.println("Коробка 2: "+or1.getWeight());
        System.out.println("Коробка 3: "+ap.getWeight());
        System.out.println("Коробка 4: "+ap1.getWeight());
    ...
    public static void swap(Object[] arr, int n1, int n2){
        System.out.println("Замена элементов "+Arrays.toString(arr));
        Object sw = arr[n1];
        arr[n1]=arr[n2];
        arr[n2]=sw;
    ...
    public static <T> void asList(T[]arr){
        ...
        System.out.println("результат преобразования : "+alt+"\n================================");
    }
}
